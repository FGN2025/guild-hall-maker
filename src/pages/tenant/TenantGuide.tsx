...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  {
    ...
    bullets: [
      ...
      "Quick Promo for Challenges — Each scheduled challenge has a Quick Promo button that renders a branded promo image (using your logo colors, the challenge cover art, the total placement points, and the window start date) and files it in your Marketing library for review.",
      "Review & Approval for Quick Promo — Quick Promo drafts now land as Pending review instead of going straight into the library. They appear on the Marketing > Review tab (formerly Agent Drafts) alongside AI drafts. Only tenant Admins and Managers can approve or reject; Marketing staff see their pending items read-only with any feedback note. Nothing is visible to players until it is approved.",
      "Edit Image From the Review Queue — Reviewers who can approve now get an Edit image button on review-queue assets. It opens the image editor with the draft loaded so typos and layout tweaks are fixed in place; saving creates a linked revision that stays Pending review.",
      "Auto-Filled Challenge Headlines — The Headline field on a challenge schedule pre-fills as 'Your Provider Name — Challenge Name', preventing hand-typed misspellings on promos. It stays fully editable.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Manager — Access to Dashboard, Player Directory, Leads, Events, Challenges, and Marketing campaigns, including approving or rejecting Quick Promo and AI drafts on the Marketing > Review tab. ZIP Codes, Subscribers, Integrations (NISC / GLDS / FGN Academy), Tenant Codes, Web Pages, Team Management, and Settings are Admin-only and not visible to Managers.",
      "Marketing — Access to Marketing campaigns, My Assets, Web Pages, Events, Challenges, and read-only visibility of Tenant Codes. Marketing staff can create Quick Promo drafts but cannot approve or publish them; an Admin or Manager must approve first. Ideal for team members focused on promotional content.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Headline Auto-Fills — The Headline field pre-fills as 'Your Provider Name — Challenge Name' so nobody has to hand-type (and misspell) the provider name. Type over it any time you want something custom (for example 'August Fiber Sprint'); leaving it untouched saves the auto-filled value. Promo copy is optional and feeds your marketing drafts.",
      ...
      "Quick Promo — One click renders a branded promo image using your logo colors, the challenge cover art, the total 1st + 2nd + 3rd placement points as the prize value, and the window start date. The image lands in My Assets and is linked to a new campaign submitted for review in Marketing.",
      "Review Before It Goes Live — Quick Promo drafts sit in Marketing > Review as Pending review. A tenant Admin or Manager approves (publishing the campaign and its image) or rejects with a note. Rejected items stay visible for 30 days so you can revise and resubmit. Nothing reaches players before approval.",
      "Fix It During Review — Reviewers with approve rights get an Edit image button next to Review asset. It opens the image editor loaded with the draft, so a typo or layout tweak can be fixed on the spot. Saving stores a new revision linked to the same campaign and keeps it in Pending review until it is approved.",
