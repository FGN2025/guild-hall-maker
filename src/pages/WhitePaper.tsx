...
const sectionData: { id: string; icon: typeof Trophy; title: string; content: string[] }[] = [
  ...
  },
  {
    ...
    content: [
      "Step 1 — Contact FGN to set up your institution as a Tenant on the platform.",
      "Step 2 — Provide your logo, brand colors, and service area ZIP codes for portal configuration.",
      "Step 3 — Invite your staff and assign roles (Admin, Manager, Marketing, Moderator).",
      "Step 4 — Define your game catalog — select which games your program will feature for tournaments and challenges.",
      "Step 5 — Create your first tournament, challenge, or quest and publish it to your community.",
      "Step 6 — Share your public event page and registration link with participants.",
      "Step 7 — Monitor your dashboard, review submissions, and watch your competitive gaming community grow.",
