...
const sectionData: { id: string; icon: typeof Target; title: string; bullets: string[] }[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Supported Formats — Upload images (JPEG, PNG, WebP) or video files as evidence. You can also paste a YouTube or Twitch link and it will render as an inline embed in the review queue.",
      "Per-Task Upload — If the challenge has a task checklist, upload evidence for each individual task independently.",
      "Re-Upload Window — You can delete and re-upload evidence freely while a task is still 'pending' or has been 'rejected' — this is your edit window.",
      "Evidence Locks On Submission — Once you submit a task for review (or once a moderator approves it), that piece of evidence becomes read-only. You cannot delete or replace approved evidence — this protects the audit trail and your point payouts.",
      "Locked but Not Stuck — If approved evidence turns out to be wrong, ask a moderator to Reject it. Rejection re-opens the slot so you can re-upload.",
      "Unenrollment Lock — Once you've submitted any evidence (or the enrollment is marked Completed), the Unenroll button disappears. You're committed for the rest of the review cycle. If something is genuinely wrong, contact a moderator.",
      "File Size — Keep uploads reasonable in size. Large video files may take longer to process and review.",
      "Notes — Add optional notes when uploading evidence to explain context to the reviewer (e.g., timestamp in a clip, in-game username).",
    ],
  },
  {
    id: "review-process",
    ...
    bullets: [
      ...
      "Per-Task Status — Each piece of evidence gets its own status: Pending (awaiting review), Approved (accepted, locked), or Rejected (delete and re-upload).",
