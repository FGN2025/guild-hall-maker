...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  {
    ...
    bullets: [
      ...
      "Scope — Moderators handle tournaments, match scoring, player points, challenges, ranked ladders, and community moderation. Prize redemptions are Admin-only.",
      "Sidebar — Use the Moderator Dashboard sidebar to navigate between Dashboard, Tournaments, Matches, Points, Challenges, Achievements, Ladders, and this Guide.",
