...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Evidence Review — Switch to the 'Evidence Review' tab to see all submitted enrollments. Expand each submission to view uploaded screenshots and videos inline, then approve or reject with notes.",
      ...
      "Rejection — Rejecting sends the enrollment back to the player with your notes so they can revise and resubmit.",
