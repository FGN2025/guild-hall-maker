...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "FGN Academy Integration — Challenge completions are automatically synced to FGN Academy's Skill Passport using a flat JSON payload (user_email, challenge_id, score, task_progress, skills_verified). Authentication uses the X-App-Key header with the FGN_ACADEMY_API_KEY secret.",
