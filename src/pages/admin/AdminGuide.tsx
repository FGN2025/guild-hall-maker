...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  ...
  },
  {
    ...
    bullets: [
      "The platform includes an automated notification system that alerts players via in-app notifications and email.",
      ...
      "Email Notifications — Both redemption status changes and new challenges also trigger email notifications via the Resend integration.",
      "Automatic Triggers — Notifications are generated by database triggers, requiring no manual action from moderators beyond their normal workflows.",
      "Mark as Read — Players can mark individual notifications as read or clear all at once.",
      "Deep Links — Each notification includes a link to the relevant page (Prize Shop, Challenges) for one-click navigation.",
      "Tip: The notification system works automatically — just approve redemptions and create challenges as usual, and players will be notified.",
    ],
  },
];
