...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Points Adjusted — When a moderator or admin awards or deducts points from your balance, you'll receive a notification with the amount and reason. Awards show as 'Points Awarded'; deductions show as 'Points Deducted'.",
      ...
      "Email Alerts — Key events (redemption updates, new challenges, points adjustments) also trigger email notifications so you never miss an update.",
      "Mark as Read — Click any notification to mark it as read, or use 'Mark all read' to clear all at once.",
      "Quick Navigation — Notifications include links that take you directly to the relevant page (e.g., Prize Shop, Challenges, Leaderboard).",
