...
const sectionData: { id: string; icon: typeof Shield; title: string; bullets: string[] }[] = [
  ...
  },
  {
    ...
    bullets: [
      "Challenges are task-based objectives that earn you bonus season points.",
      ...
      "Tip: Check daily for new challenges — they're one of the fastest ways to earn season points.",
    ],
  },
  {
    id: "prize-shop",
