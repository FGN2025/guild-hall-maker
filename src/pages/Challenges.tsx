    ...
    <>
      ...
      <div className="space-y-6">
        <Button
          asChild
          variant="outline"
          className="group w-fit gap-2 border-border bg-card/80 font-body text-muted-foreground backdrop-blur-sm transition-colors hover:border-primary hover:bg-card hover:text-primary"
        >
          <Link to="/challenges">
          ...
          <div className="rounded-xl bg-black/40 backdrop-blur-sm border border-white/10 p-3">
            <div className="flex flex-wrap gap-2">
              <Badge
                ...
                className={`cursor-pointer font-semibold ${gameFilter === null ? "" : "text-white bg-white/10 border border-white/40 hover:bg-white/20"}`}
              ...
              {gameNames.map((name) => (
                <Badge
                  ...
                  className={`cursor-pointer font-semibold ${gameFilter === name ? "" : "text-white bg-white/10 border border-white/40 hover:bg-white/20"}`}
          ...
          <div className="space-y-8">
            {activeChallenges.length > 0 && (
              <div className="space-y-3">
                <h2 className="font-display text-xl font-bold text-white neon-text">Available Challenges</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
