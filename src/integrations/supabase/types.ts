    ...
    Tables: {
      ...
      marketing_assets: {
        Row: {
          ...
          universal_published_by: string | null
    ...
    Views: {
      ...
      tenants_public: {
        Row: {
          ...
          plan_tier: string | null
          primary_color: string | null
          require_subscriber_validation: boolean | null
          slug: string | null
          status: string | null
      ...
      v_universal_asset_adoption_matrix: {
        Row: {
