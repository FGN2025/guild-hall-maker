...
function buildTournamentPromo(t: any): PromoData {
  ...
  if (t.prize_pool) {
    texts.push({ text: `Prize: ${t.prize_pool}`, xPct: 0.05, yPct: 0.89, x: 40, y: 534, fontSize: 20, color: "#ffd700", fontFamily: "sans-serif" });
  }
